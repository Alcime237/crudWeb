      ...
      <div class="box">
        <div class="inner-box">
          <div class="forms-wrap">
            <form action="Modif.php" autocomplete="off" class="sign-in-form"enctype="multipart/form-data" method="post" >
              ...
              <div class="actual-form">
                ...
                <input type="submit" value="Modifier" class="sign-btn" />
              </div>
              <div class="creer">
            ...
            <form action="Ajout.php" autocomplete="off" class="sign-up-form" method="post"enctype="multipart/form-data" >
              ...
              <div class="creer">
                <h6>Modifier votre Compte?</h6>
                <a href="#" class="toggle">Modifier</a>
              </div>
            </form>
          </div>
